...
class CustomerVideoSerializer(serializers.ModelSerializer):
	class Meta:
		model = Video_Model
		fields = "__all__"

class CustomerFaqsSerializer(serializers.ModelSerializer):
	class Meta:
		model = FAQs_Model
		fields = "__all__"
...
class CustomerOffersListSerializer(serializers.ModelSerializer):
	class Meta:
		model = OfferModel
		fields = "__all__"


class CustmomerInfoSerializer(serializers.ModelSerializer):
	class Meta:
