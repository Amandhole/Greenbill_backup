...
def ShareWord_view(request):

    SharedWords = ShareWord.objects.all().order_by('-id')
    
    context = {
        "ShareWordNavclass": "active",
        "SharedWords": SharedWords,  
    }

    return render(request, "super_admin/share-word/share-word.html", context)