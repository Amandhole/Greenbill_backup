...
urlpatterns = [
    ...
    path("customer-info/<str:mobile_no>", views.customer_info_by_mobile_no, name="customer-info-by-mobile-no"),
    path("customer-info-send-bill-sms-web/<int:id>/", views.CustomerInfoSendBillSMSWeb, name="customer-info-send-bill-sms-web"),
    
    path("customer-csv-upload/", views.Customer_CSV_Upload,
         name="customer-csv-upload"),
    path("edit_cust_info/", views.Edit_Cust_info, name="edit_cust_info"),
    path("delete_cust/<int:id>", views.Delete_Customer, name="delete_cust"),
    path("check_number/<int:id>",views.Check_Contact, name="check_number"),

    path("view-cashmemo-by-no/<str:mobile_no>/", views.ViewAllCashMemoByNumber, name="view-cashmemo-by-no"),

    path("view-receipt-by-no/<str:mobile_no>/", views.ViewAllReceiptMemoByNumber, name="view-receipt-by-no"),
